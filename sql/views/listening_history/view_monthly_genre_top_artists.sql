CREATE OR REPLACE VIEW gold.view_monthly_genre_top_artists AS
SELECT
...
GROUP BY month, a.artist_genre, f.artist_id, a.artist_name
ORDER BY month, a.artist_genre, total_minutes_listened DESC;
