DROP TABLE IF EXISTS silver.spotify_saved_genres;

CREATE TABLE silver.spotify_saved_genres (
...
INSERT INTO silver.spotify_saved_genres (
...
FROM bronze.spotify_saved_genres
